...
M.get_mappings = function(mappings, tb_to_add)
  local excluded_groups = require("nyxconfig").cheatsheet.excluded_groups
...
M.organize_mappings = function(tb_to_add)
  ...
  for _, mode in ipairs(modes) do
    ...
    require("nyxvim.cheatsheet").get_mappings(keymaps, tb_to_add)

    local bufkeymaps = vim.api.nvim_buf_get_keymap(0, mode)
    require("nyxvim.cheatsheet").get_mappings(bufkeymaps, tb_to_add)
  end
