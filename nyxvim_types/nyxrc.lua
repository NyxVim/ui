...
---@field cheatsheet? NyxCheatsheetConfig
...
---     }
--- ```
--- see https://github.com/NyxVim/base46/tree/main/lua/base46/integrations
...
--- see https://github.com/NyxVim/base46/tree/main/lua/base46/themes for the colors of each theme
...
--- see https://github.com/NyxVim/base46/tree/main/lua/base46/themes
...
---@class UIConfig
---@field cmp? NyxCmpConfig
---@field telescope? NyxTelescopeConfig
---@field statusline? NyxStatusLineConfig
---@field tabufline? NyxTabLineConfig
---@field nyxdash? NyxDashboardConfig
--- Whether to enable LSP Semantic Tokens highlighting
--- List of extras themes for other plugins not in NyxVim that you want to compile
...
---@class NyxTelescopeConfig
--- Telescope style
---@field style? '"borderless"'|'"bordered"'

---@class NyxStatusLineConfig
--- statusline theme
---@field theme? '"default"'|'"vscode"'|'"vscode_colored"'|'"minimal"'
--- Separator style for NyxVim Statusline
...
--- Check https://github.com/NyxVim/ui/blob/main/lua/nyxvim/stl/utils.lua#L12 for the modules of each statusline theme
---@field order? string[]
...
--- Options for NyxVim Tabufline
---@class NyxTabLineConfig
...
---@field buttons? NyxDashButtonConfig[] | function[]
...
---Options for NyxVim/ui lsp configuration
---@class NyxLspConfig
